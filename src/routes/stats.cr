...
router.namespace "/stats" do
  ...
  get "/repositories_growth" do |env|
  ...
  get "/direct_dependencies" do |env|
  ...
  get "/reverse_dependencies" do |env|
  ...
  get "/user_repositories_count" do |env|
  ...
  get "/repositories_provider_count" do |env|
  ...
  get "/users_provider_count" do |env|
